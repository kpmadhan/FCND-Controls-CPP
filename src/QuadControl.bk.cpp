...
VehicleCommand QuadControl::GenerateMotorCommands(float collThrustCmd, V3F momentCmd)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
   ...
   /* float l = L / sqrtf(2.f);
    ...
    float t_1 = momentCmd.x / l;
    float t_2 = momentCmd.y / l;
    float t_3 = - momentCmd.z / kappa;
    float t_4 = collThrustCmd;
    
    cmd.desiredThrustsN[0] = CONSTRAIN((t_1 + t_2 + t_3 + t_4)/4.f, minMotorThrust, maxMotorThrust);
    cmd.desiredThrustsN[1] = CONSTRAIN((-t_1 + t_2 - t_3 + t_4)/4.f, minMotorThrust, maxMotorThrust);
    cmd.desiredThrustsN[2] = CONSTRAIN((t_1 - t_2 - t_3 + t_4)/4.f, minMotorThrust, maxMotorThrust);
    cmd.desiredThrustsN[3] = CONSTRAIN((-t_1 - t_2 + t_3 + t_4)/4.f, minMotorThrust, maxMotorThrust);
    */
    float l = L / sqrtf(2.f);
